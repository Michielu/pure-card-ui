...
import {
  DB_NAME, STORE_BEST, STORE_STAPLES, STORE_SPECIALTIES, STORE_CARDS, STORE_DEFAULT,
} from './consts';
...
const getFromBestStore = async (key: string) => db.get(STORE_BEST, key);
const getFromStaplesStore = async (key: string) => db.get(STORE_STAPLES, key);
const getFromSpecialtiesStore = async (key: string) => db.get(STORE_SPECIALTIES, key);
const getFromDefaultStore = async (key: string) => db.get(STORE_DEFAULT, key);
...
const getAllFromBestStore = async () => db.getAll(STORE_BEST);
const getAllFromStaplesStore: any = async () => db.getAll(STORE_STAPLES);
const getAllFromSpecialtiesStore: any = async () => db.getAll(STORE_SPECIALTIES);
const getAllFromDefaultStore: any = async () => db.getAll(STORE_DEFAULT);
